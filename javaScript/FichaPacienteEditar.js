document.addEventListener("DOMContentLoaded", function () {
    ...
    /*
     Se reautiliza el bloque de arriba de fichapaciente.js sirve para buscar por id
     tambien valida si un paciente que tiene una ficha medica 
    */

    document.getElementById("pacienteId").value = pacienteSeleccionado.id
    document.getElementById("nombre").value = pacienteSeleccionado.nombre
    document.getElementById("rut").value = pacienteSeleccionado.rut
    ...
    document.getElementById("correo").value = pacienteSeleccionado.correo
    document.getElementById("enfermedades").value = pacienteSeleccionado.enfermedades
    document.getElementById("alergias").value = pacienteSeleccionado.alergias
    document.getElementById("medicamentos").value = pacienteSeleccionado.medicamentos
    document.getElementById("alimentacion").value = pacienteSeleccionado.alimentacion
    document.getElementById("comidas").value = pacienteSeleccionado.comidas
    document.getElementById("agua").value = pacienteSeleccionado.agua
    document.getElementById("actividad").value = pacienteSeleccionado.actividad
    document.getElementById("peso").value = pacienteSeleccionado.peso
    document.getElementById("estatura").value = pacienteSeleccionado.estatura
    document.getElementById("imc").value = pacienteSeleccionado.imc
    document.getElementById("objetivo").value = pacienteSeleccionado.objetivo
    document.getElementById("observaciones").value = pacienteSeleccionado.observaciones
    document.getElementById("recomendaciones").value = pacienteSeleccionado.recomendaciones
...
formulario.addEventListener("submit", function (evento) {
    ...
    let pacientesCargados = JSON.parse(localStorage.getItem("pacientes"))
    let posicion = pacientesCargados.findIndex(function (i){

        return i.id === pacienteActualizado.id;
    })
    pacientesCargados[posicion] = pacienteActualizado
    localStorage.setItem("pacientes", JSON.stringify(pacientesCargados))
